...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("FIRE Core firelynxcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  firelynxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded firelynxcoin transaction") + "\n" +
              "  firelynxcoin-tx [options] -create [commands]   " + _("Create hex-encoded firelynxcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded firelynxcoin transaction
