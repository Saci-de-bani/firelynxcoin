    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("FIRE Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About FIRE Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  firelynxcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the FIRE in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FIRE, 0.1 FIRE, 1 FIRE and 10 FIRE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://firelynxcoinpay.atlassian.net/wiki/display/DOC/DDNSend\">https://firelynxcoinpay.atlassian.net/wiki/display/DOC/DDNSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("FIRE Core is shutting down...") + "<br /><br />" +
