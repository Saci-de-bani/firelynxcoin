    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("FIRE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FIRE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and firelynxcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About FIRE Core"), this);
    aboutAction->setStatusTip(tr("Show information about FIRE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FIRE Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FIRE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FIRE addresses"));
    ...
    openAction->setStatusTip(tr("Open a firelynxcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FIRE Core help message to get a list with possible FIRE Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FIRE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FIRE network", "", count));
    } else {
...
{
    QString strTitle = tr("FIRE Core"); // default title
