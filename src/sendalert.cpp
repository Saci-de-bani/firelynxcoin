...
2. run firelynxcoind with -printalert or -sendalert like this:
   /path/to/firelynxcoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.firelynxcoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/FIRE Core:0.12.0.58/"));
