...
Firelynx Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
Format: ```mngovernance prepare proposal-name url payment-count block-start firelynxcoin-address monthly-payment-firelynxcoin```
...
Format: ```mngovernance submit proposal-name url payment-count block-start firelynxcoin-address monthly-payment-firelynxcoin fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using firelynxcoin.conf setup)
