...
Firelynx Coin is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Firelynx Coin, where everyone uses
...
pay attention to for reviewers of Firelynx Coin code.

General Firelynx Coin
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Firelynx Coin uses tinyformat, which is type safe. Leave them out to avoid confusion
