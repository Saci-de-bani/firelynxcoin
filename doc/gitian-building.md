...
git clone https://github.com/saci-de-bani/firelynxcoin
```
...
```bash
    ...
    From https://github.com/saci-de-bani/firelynxcoin
...
cd /some/root/path/
git clone https://github.com/saci-de-bani/firelynxcoin-detached-sigs.git
...
[firelynxcoin/gitian.sigs](https://github.com/saci-de-bani/gitian.sigs/) repository, or if that's not possible to create a pull
request.
