...
Only requiring some minor changes is firelynxcoin.cpp.
...
Changes to firelynxcoin.cpp
----------------------
firelynxcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
